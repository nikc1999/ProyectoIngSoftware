...
@if (Auth::user()->rol == 'Jefe de Carrera')
    ...
    <br>
    <div class="d-grid gap-2">
        <center><a href={{ route('buscarestudiante.index')}}><button style="color:white; background-color:rgb(205,167,136)" class="btn" type="button">Buscar Estudiante</button></a></center>
    </div>
@else
@php
